...
public class SkillCreator extends Application {
	...
	private TextField damageTextField = new TextField("-35%");
	...
	private TextField effect1TextField = new TextField("Antiq Distract 3");
	private TextField effect2TextField = new TextField("Destealth");
	...
	private TextField healHighPerLevelTextField = new TextField("2");
			...
			fullSkillCode = "";
				...
				if(!skillNameTextField.getText().toString().matches("")) {
					if((!player1.isSelected()) && (!player2.isSelected()) && (!player3.isSelected()) && (!player4.isSelected())) {
						...
						errorStatus = "Player Position Selected";
						errorLabel.setText("Error required info: " + '\n' + errorStatus);
						...
						if((!enemy1.isSelected() && !enemy2.isSelected() && !enemy3.isSelected() && !enemy4.isSelected()) && (targetTypeCombo.getValue().toString() == "Enemy" || targetTypeCombo.getValue().toString() == "Allies")) {
							...
							errorLabel.setVisible(false);
							successLabel.setVisible(false);
							errorStatus = "Enemy/Ally Selected";
							errorLabel.setText("Error required info: " + '\n' + errorStatus);
							...
							if(damageTypeCombo.getValue().toString() == "Heal") {
								try {
									...
									errorLabel.setVisible(false);
									successLabel.setVisible(false);
									errorStatus = "Number Parse Error.";
